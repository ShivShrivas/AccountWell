package com.bsninfotech.accountwell.Model;
...
public class ServerApi {
   ...
   // public static String LOGIN_API="/Common.svc/mobile/MGetUserId";
    public static String LOGIN_API="/Common.svc/mobile/MGetUserId";
    public static String FORGOT_PASSWORD= "/MailMessageService.svc/mobile/MRecoverPassword";
    public  static  String GET_FYID="/AccountMaster.svc/mobile/MSGetFYs";
    public  static  String GET_COMPANY="/CompanyMaster.svc/mobile/MSGetCompanyMaster";
    public  static  String GET_SITE="/CompanyMaster.svc/mobile/MSGetCompanyBranchMaster";

    public static String GETURL_API= "/Common.svc/mobile/MGetUrl";
    public static String GET_DASHBOARD= "/Common.svc/mobile/MGetUser";
    public  static  String GET_CASHSUMMARY="/ReportService.svc/mobile/MGetDashboardStatistics";
    public  static  String GET_CREDITORSUMMARY="/ReportService.svc/mobile/MGetDashboardStatistics";
    public  static  String GET_DEBITORSUMMARY="/ReportService.svc/mobile/MGetDashboardStatistics";
    public  static  String GET_TRNASACTIONSUMMARY="/ReportService.svc/mobile/MGetDashboardStatistics";

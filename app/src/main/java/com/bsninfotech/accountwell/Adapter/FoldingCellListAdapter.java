...
public class FoldingCellListAdapter extends ArrayAdapter<CashSummary_Helper> {

    private HashSet<Integer> unfoldedIndexes = new HashSet<>();
    private View.OnClickListener defaultRequestBtnClickListener;

    public FoldingCellListAdapter(Context context, List<CashSummary_Helper> objects) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        CashSummary_Helper item = getItem(position);

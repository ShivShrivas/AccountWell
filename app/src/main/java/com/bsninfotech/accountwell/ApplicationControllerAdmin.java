...
public class ApplicationControllerAdmin extends Application {
    ...
    private String User_desgn,school_name,userProfile_logo;
    ...
    public String getuserProfile_logo() {
        return userProfile_logo;
    }
    public void setuserProfile_logo(String userProfile_logo) {
        this.userProfile_logo = userProfile_logo;
    }

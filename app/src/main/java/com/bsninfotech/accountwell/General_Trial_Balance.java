...
public class General_Trial_Balance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_general__trial__balance);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        TypefaceUtil fontChanger = new TypefaceUtil(getAssets(), "fonts/" + ServerApi.FONT_DASHBOARD);
        fontChanger.replaceFonts((LinearLayout)findViewById(R.id.layout_general_balance));
        SpannableString str = new SpannableString("General Trial Bal.(2019-2020)");
        ...
        StockLedger_Adapter adapter = new StockLedger_Adapter(General_Trial_Balance.this, R.layout.item_stockledger, cashlist);
